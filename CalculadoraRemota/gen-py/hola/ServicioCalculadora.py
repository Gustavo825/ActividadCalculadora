...
class Client(Iface):
    ...
    def multiplicar(self, numero1, numero2):
        ...
        """
        self.send_multiplicar(numero1, numero2)
        return self.recv_multiplicar()

    def send_multiplicar(self, numero1, numero2):
    ...
    def restar(self, numero1, numero2):
        ...
        """
        self.send_restar(numero1, numero2)
        return self.recv_restar()

    def send_restar(self, numero1, numero2):
    ...
    def dividir(self, numero1, numero2):
        ...
        """
        self.send_dividir(numero1, numero2)
        return self.recv_dividir()

    def send_dividir(self, numero1, numero2):
...
class Processor(Iface, TProcessor):
    ...
    def process_multiplicar(self, seqid, iprot, oprot):
        ...
        result = multiplicar_result()
        try:
            result.success = self._handler.multiplicar(args.numero1, args.numero2)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_restar(self, seqid, iprot, oprot):
        ...
        result = restar_result()
        try:
            result.success = self._handler.restar(args.numero1, args.numero2)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_dividir(self, seqid, iprot, oprot):
        ...
        result = dividir_result()
        try:
            result.success = self._handler.dividir(args.numero1, args.numero2)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
